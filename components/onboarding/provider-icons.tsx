...
export function OpenAIIcon({ className }: IconProps) {
  return (
    <div className={cn("w-10 h-10 bg-white rounded-lg flex items-center justify-center border", className)}>
...
export function GoogleIcon({ className }: IconProps) {
  return (
    <div className={cn("w-10 h-10 bg-white border rounded-lg flex items-center justify-center", className)}>
...
export function XAIIcon({ className }: IconProps) {
  return (
    <div className={cn("w-10 h-10 bg-black rounded-lg flex items-center justify-center", className)}>
...
export function getProviderIcon(providerId: string, className?: string) {
  switch (providerId) {
    ...
    default:
      return (
        <div className={cn("w-10 h-10 bg-muted rounded-lg flex items-center justify-center", className)}>
          <span className="font-semibold text-sm">{providerId.charAt(0).toUpperCase()}</span>
        </div>
      );
  }
}